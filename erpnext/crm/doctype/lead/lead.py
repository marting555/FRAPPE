...
class Lead(SellingController, CRMNote):
	...
	if TYPE_CHECKING:
		...
		bank_name: DF.Literal["Agribank (Vietnam Bank for Agriculture and Rural Development)", "BIDV (Bank for Investment and Development of Vietnam)", "VietinBank (Vietnam Joint Stock Commercial Bank for Industry and Trade)", "Vietcombank (Bank for Foreign Trade of Vietnam)", "VBSP (Vietnam Bank for Social Policies)", "VDB (Vietnam Development Bank)", "VPBank (Vietnam Prosperity Bank)", "MB (Military Bank)", "Techcombank (Vietnam Technological and Commercial Bank)", "ACB (Asia Commercial Bank)", "SHB (Saigon - Hanoi Bank)", "HDBank (Ho Chi Minh City Development Bank)", "LienVietPostBank (Lien Viet Post Joint Stock Commercial Bank)", "VIB (Vietnam International Bank)", "SeABank (Southeast Asia Bank)", "TPBank (Tien Phong Bank)", "OCB (Orient Commercial Bank)", "MSB (Maritime Bank)", "SCB (Saigon Commercial Bank)", "Sacombank (Saigon Thuong Tin Bank)", "Eximbank (Export Import Bank of Vietnam)", "NCB (National Citizen Bank)", "Nam A Bank", "ABBank (An Binh Bank)", "PVcomBank (Vietnam Public Joint Stock Commercial Bank)", "BAC A Bank", "VietBank (Vietnam Thuong Tin Bank)", "Viet A Bank", "BVBank (Viet Capital Bank)", "DongA Bank", "KienlongBank (Kien Long Bank)", "SaigonBank (Saigon Industry and Trade Bank)", "BaoViet Bank", "PG Bank (Petrolimex Group Bank)", "ANZ Bank (Australia and New Zealand Banking Group)", "CIMB Bank (Malaysia)", "Hong Leong Bank", "HSBC Vietnam", "Public Bank Vietnam", "Shinhan Bank Vietnam", "Standard Chartered Bank Vietnam", "Woori Bank", "UOB Vietnam (United Overseas Bank)", "Citibank Vietnam", "KBank (Kasikorn Bank)", "Bangkok Bank Vietnam", "Deutsche Bank Vietnam", "Indovina Bank (IVB)", "VRB (Vietnam - Russia Joint Venture Bank)", "GPBank (Global Petroleum Bank)", "OceanBank (Ocean Commercial Bank)", "CBBank (Construction Bank)", "VCCB (Vietcombank Digital Bank)", "VABank (VietBank Digital)", "Modern Vietnam Bank (fictional/example)"]
