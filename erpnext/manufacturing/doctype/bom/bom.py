...
class BOM(WebsiteGenerator):
	...
	def get_bom_material_detail(self, args=None):
		...
		ret_item = {
			...
			"uom": args.get("uom") if args.get("uom") is not None else args.get("stock_uom"),
			"conversion_factor": args.get("conversion_factor") if args.get("conversion_factor") is not None else 1,
			"bom_no": args["bom_no"],
			"rate": rate,
