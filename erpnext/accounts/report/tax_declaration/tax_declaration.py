...
def fetch_tax_data(filters):
    ...
    tax = result[0]
    return [
        {"rubric": "1a", "description": _("Domestic sales with high tax rate (21%)"), "amount": tax.domestic_high_rate},
        {"rubric": "1b", "description": _("Domestic sales with low tax rate (9%)"), "amount": tax.domestic_low_rate},
        {"rubric": "1c", "description": _("Other tax rates"), "amount": tax.domestic_other_rates},
        {"rubric": "1d", "description": _("Private use (privégebruik)"), "amount": tax.private_use},
        {"rubric": "1e", "description": _("Sales at 0% or exempt (vrijgesteld)"), "amount": tax.exempt_sales},
        {"rubric": "2a", "description": _("Domestic reverse charge (verlegd)"), "amount": tax.reverse_charge},
        {"rubric": "3a", "description": _("Exports outside the EU"), "amount": tax.export_outside_EU},
        {"rubric": "3b", "description": _("Intra-EU sales"), "amount": tax.intra_EU_sales},
        {"rubric": "3c", "description": _("Distance/installation sales within EU"), "amount": tax.distance_sales_EU},
        {"rubric": "4a", "description": _("Services from outside the EU"), "amount": tax.services_outside_EU},
        {"rubric": "4b", "description": _("Services from within the EU"), "amount": tax.services_EU},
        {"rubric": "5b", "description": _("Input tax from purchases"), "amount": tax.input_tax},
        {"rubric": "5a", "description": _("Total output tax payable"), "amount": tax.output_tax_due},
        {"rubric": "5c", "description": _("Subtotal (output tax - input tax)"), "amount": tax.net_payable_or_refundable},
        ...
        {"rubric": "Total", "description": _("Tax Payable/Refundable"), "amount": tax.net_payable_or_refundable}
    ]
