...
class Employee(NestedSet):
	...
	if TYPE_CHECKING:
		...
		from erpnext.setup.doctype.employee_emergency_contacts.employee_emergency_contacts import EmployeeEmergencyContacts
		...
		emergency_contacts: DF.Table[EmployeeEmergencyContacts]
